...
public class HotelManage 
{
	public static void main(String[] args) 
	{
	  ...
	  System.out.println(" ");
	  System.out.println("Mashala Sandwich\t"+"60\t\t"+"1");
	  System.out.println("Chij Mashala Sandwich\t"+"70\t\t"+"2");
	...
	do
	   {
		   ...
		   for(int k=0;k<press.length;k++)
		   {
			   ...
			   if(press[k]==1)
			   {
				   fetchitemname="Mashala Sandwich";  
			   }
			   if(press[k]==2)
			   {
				   fetchitemname="Chij Mashala Sandwich";  
			   }
			   if(press[k]==3)
			   {
